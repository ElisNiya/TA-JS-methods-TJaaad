...
let fruitsArray = Object.keys(fruitsObj).reduce((acc,cv) => {       // this way we get access to all keys
  acc = acc.concat([cv, fruitsObj[cv]]);      //cv -keys.   fruitsObj[cv]. - nr of times of keys
  return acc;
}, []);        
...
// Using reduce flat the data in the array
